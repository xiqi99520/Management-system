      ...
      <el-form :inline="true" :model="filterData" class="form" size="mini">
        <el-row type="flex" justify="space-between">
          <el-col align="left">
            ...
            <el-form-item>
              <el-select v-model="filterData.distribution" placeholder="全部/已分配/未分配">
      ...
      <el-table :data="tableData" stripe border style="width: 100%" size="mini">
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button @click="handleView(scope.row)" type="text" size="small">{{scope.row.riskManager}}</el-button>
          </template>
        </el-table-column>
      </el-table>
      <!-- 分页 -->
    ...
    data () {
      return {
        ...
        tableData: [{
          ...
          sex: '男',
          telnum: '134xxxx7123',
          scoreTime: '2017/10/12 10:00',
          loanMoney: '120',
          loanDeadline: '12个月',
          isCancel: '是',
          address: '朝阳区肖云路66号霞光里8栋803',
          orderTime: '2017/10/12 11:00',
          burningTime: '1小时0分钟',
          riskManager: '小刘'
        }, {
          applyId: 'FC0001',
